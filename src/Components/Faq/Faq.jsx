                                    ...
                                    <ul>
                                        <li>
                                            <a href="#aboutfaq" class="active">
                                                <i class="fa fs-4 firsti"><MdKeyboardArrowRight /></i> About Fantra
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#bankingfaq">
                                                <i class="fa fs-4 firsti"><MdKeyboardArrowRight /></i> Banking
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#winingfaq">
                                                <i class="fa fs-4 firsti"><MdKeyboardArrowRight /></i> Wining
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#securityfaq">
                                                <i class="fa fs-4 firsti"><MdKeyboardArrowRight /></i> Security
                                            </a>
                                        </li>
                                    </ul>
                                </div>
